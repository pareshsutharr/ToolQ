...
export const tools: ToolMeta[] = [
  ...
  },
  {
    ...
    group: "convert",
    name: "CSV to Excel",
    description: "Convert one or more CSV files into a formatted Excel workbook.",
    premium: "free",
    seoKeyword: "csv to excel converter",
    keywords: [
      "convert csv to xlsx",
      "csv to spreadsheet",
      "import csv into excel",
      "csv file to excel online",
  ...
  },
  {
    ...
    keywords: ["pdf to docx", "convert pdf to word online", "make pdf editable in word", "pdf to doc"],
  },
  {
    slug: "word-to-pdf",
    category: "pdf",
    ...
    keywords: ["docx to pdf", "convert word to pdf online", "doc to pdf"],
  },
  {
    slug: "to-html",
    category: "pdf",
    group: "convert",
    name: "PDF to HTML",
    description: "Convert a PDF into a self-contained HTML file.",
    premium: "free",
    seoKeyword: "pdf to html converter",
    keywords: ["pdf to webpage", "convert pdf to html online", "pdf to html5"],
  },
  {
    slug: "html-to-pdf",
    category: "pdf",
    group: "convert",
    name: "HTML to PDF",
    description: "Render an HTML file or snippet as a paginated PDF.",
    premium: "free",
    seoKeyword: "html to pdf converter",
    keywords: ["convert webpage to pdf", "html file to pdf online", "save html as pdf"],
  },
  {
    slug: "to-powerpoint",
    category: "pdf",
    ...
    description: "Turn each PDF page into a slide in a PowerPoint presentation.",
    premium: "free",
    seoKeyword: "pdf to powerpoint converter",
    keywords: ["pdf to ppt", "pdf to pptx", "convert pdf to powerpoint online"],
  },
  {
    ...
    premium: "free",
    seoKeyword: "powerpoint to pdf converter",
    keywords: ["ppt to pdf", "pptx to pdf", "convert powerpoint to pdf online"],
  },
  {
    slug: "rotate",
    category: "pdf",
